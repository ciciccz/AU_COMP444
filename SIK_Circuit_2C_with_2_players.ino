...
Note melody[] = {
  { 659, 200 }, { 659, 200 }, { 0, 200 }, { 659, 200 }, { 0, 200 }, { 523, 200 }, { 659, 200 }, { 0, 200 }, { 784, 200 }, { 0, 400 }, { 392, 200 }, { 0, 400 }, { 523, 200 }, { 0, 400 }, { 392, 200 }, { 0, 400 }, { 330, 200 }, { 0, 200 }, { 440, 200 }, { 0, 200 }, { 494, 200 }, { 0, 200 }, { 466, 200 }, { 440, 200 }, { 392, 400 }, { 659, 200 }, { 784, 200 }, { 880, 200 }, { 0, 200 }, { 698, 200 }, { 784, 200 }, { 0, 200 }, { 659, 200 }, { 0, 200 }, { 523, 200 }, { 587, 200 }, { 494, 200 }, { 0, 400 }, { 523, 200 }, { 0, 400 }, { 392, 200 }, { 0, 400 }, { 330, 200 }, { 0, 400 }, { 440, 200 }, { 0, 200 }, { 494, 200 }, { 0, 200 }, { 466, 200 }, { 440, 200 }, { 392, 400 }, { 659, 200 }, { 784, 200 }, { 880, 200 }, { 0, 200 }, { 698, 200 }, { 784, 200 }, { 0, 200 }, { 659, 200 }, { 0, 200 }, { 523, 200 }, { 587, 200 }, { 494, 200 }, { 0, 400 }
};
...
int buttonSequence[3];  //make an array of numbers that will be the sequence that the player needs to remember
...
void loop() {
  ...
  for (int i = 0; i <= roundCounter; i++) {  //for each button to be pressed in the sequence
    if (checkRedYellowPressed()) {
      playAnySong(melody, melodySize);
      break;
    }
    ...
    while (gameStarted == true) {  //loop until the player presses a button or the time limit is up (the time limit check is in an if statement)
      ...
      int currentPlayer = 0;  //two player sequential mode
      while (currentPlayer < 2) {
        ...
        currentPlayer += 1;  //goes to next player
        delay(2000);         //so the next player can get ready
      }
    }
  }
...
bool checkRedYellowPressed() {
  (digitalRead(button[0]) == LOW) && (digitalRead(button[1]) == LOW) == LOW ? true : false;
}
//START SEQUENCE
void startSequence() {
